const abi = [
  ...
  {
    inputs: [{ internalType: "address", name: "assetContract", type: "address" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "bool", name: "cancelled", type: "bool" },
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "assetContract", type: "address" },
      {
        components: [
          ...
          { internalType: "uint64", name: "rentalExpirationTimestamp", type: "uint64" },
          { internalType: "enum IDSponsorMarketplace.Status", name: "status", type: "uint8" },
  ...
  },
  {
    ...
    name: "makeOffer",
    outputs: [{ internalType: "uint256", name: "_offerId", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function"
  },
  {
